...
<head>
    ...
    <title>Sign Up Form for MASHUPSTACK</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="#" class="register-form" id="register-form">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="password" name="cpass" id="re_pass" placeholder="Repeat your password"/>
                            </div> -->
                            <!-- <div class="form-group">
                    ...
                    <div class="signup-image">
                        <figure><img src="<?php echo base_url(); ?>/assets/loginpage3/images/signup-image.jpg" alt="sing up image"></figure>
